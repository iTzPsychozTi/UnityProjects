...
public class SpawnManager : MonoBehaviour
{
    ...
    void SpawnRandomPrefab()
    {
        ...
        Vector3 spawnPos = new Vector3(Random.Range(leftBound, rightBound),
            0, spawnPosZ);

        //spawn our animal
        Instantiate(prefabsToSpawn[prefabIndex], spawnPos,
            prefabsToSpawn[prefabIndex].transform.rotation);
    }
}
